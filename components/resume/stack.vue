...
<template>
  <div class="stack">
    <h3 class="text-md font-medium uppercase pb-3 text-center">Tech Stack</h3>

    <div class="list flex flex-wrap gap-3 lg:justify-center">
      <!-- Svelte -->
      <div v-tooltip="'Svelte/Sveltekit'">
        <IconSvelte class="w-[2.5rem] h-[2.5rem]" />
      </div>

      <!-- Nuxt -->
      <div v-tooltip="'Nuxt'">
        <IconNuxt class="w-[2.5rem] h-[2.5rem]" />
      </div>

      <!-- Vue -->
      <div v-tooltip="'Vue'">
        <IconVue class="w-[2.5rem] h-[2.5rem]" />
      </div>

      <!-- Typescript -->
      <div v-tooltip="'Typescript'">
        <IconTypescript class="w-[2.5rem] h-[2.5rem]" />
      </div>

      <!-- Docker -->
      <div v-tooltip="'Docker'">
        <IconDocker class="w-[2.5rem] h-[2.5rem]" />
      </div>

      <!-- AWS -->
      <div v-tooltip="'AWS'">
        <IconAws class="w-[2.5rem] h-[2.5rem]" />
      </div>

      <!-- Digitalocean -->
      <div v-tooltip="'DigitalOcean'">
        <IconDigitalOcean class="w-[2.5rem] h-[2.5rem]" />
      </div>

      <!-- Tailwind -->
      <div v-tooltip="'Tailwind'">
        <IconTailwind class="w-[2.5rem] h-[2.5rem]" />
      </div>

      <!-- Drizzle -->
      <div v-tooltip="'Drizzle ORM'">
        <IconDrizzle class="w-[2.5rem] h-[2.5rem]" />
      </div>

      <!-- Postgresql -->
      <div v-tooltip="'Postgresql'">
        <IconPostgresql class="w-[2.5rem] h-[2.5rem]" />
      </div>
      ...
      <!-- Laravel -->
      <div v-tooltip="'Laravel'">
        <IconLaravel class="w-[2.5rem] h-[2.5rem]" />
      </div>

      <!-- Php -->
      <div v-tooltip="'PHP'">
        <IconPhp class="w-[2.5rem] h-[2.5rem]" />
      </div>
    </div>
  </div>
</template>
