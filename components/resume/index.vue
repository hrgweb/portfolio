...
<template>
  ...
  >
    <div class="resume-header flex flex-col items-center lg:flex-row lg:gap-7">
      <Avatar
      ...
      <div class="info text-center lg:flex lg:flex-col lg:items-start">
        ...
        <ul class="flex items-center gap-2 justify-center py-8 lg:py-0 lg:pt-4">
          <li v-for="social in info.social" class="cursor-pointer">
            <Social :name="social.name as SocialType" :social="social" />
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="resume-wrapper flex flex-col gap-10">
      <div class="about">
        ...
        <p class="text-justify">
          Hergen is a Web Developer for 7 years of professional experienced. He
          loves writing codes the right way. A big fan of best practices and
          adhere to conventions. He strive to adapt the latest trends of
          technology to create exceptional web apps. Most of his works were
          built from the ground up. Meticulously design and develop to cater the
          needs of the clients. He believes that if he can make the clients
          happy then its a win win situation. Wanna
